...
class GUI:
    ...
    def __init__(self):
        ...
        self.screen1.geometry(f"{self.screen_x}x{self.screen_y}+{str(self.x)}+{str(self.y)}")
    ...
    def login_screen(self):
        ...
        self.logo_widget=tk.Label(self.frame1,image=self.logo,bd=0,bg=teal)
    ...
    def card_screen(self):
        ...
        self.drop.config(bg=teal,fg="white",highlightthickness=0,state="disabled",width=20)
    ...
    def add_func(self):
        ...
        if self.add_grid_visible==False:
            ...
            if (self.name.get() =="" and self.num.get() =="" and self.mail.get() ==""):
                ...
                rec=[card_no,self.name.get(),self.num.get(),self.mail.get()]
    ...
    def search(self):
        ...
        if len(self.options)==0:
            messagebox.showerror('Error', 'No Devices found. Please check that your device is plugged in properly.')
            return
        self.drop["menu"].delete(0, 'end')
        for i in self.options:
            self.drop["menu"].add_command(label=i, command=lambda port=str(i): self.open(port))
    ...
    def open(self,port):
        try:
            ...
            messagebox.showerror('Error', 'Unable to Open the Port. Please check that your device is plugged in and you have selected the correct COM port.')
